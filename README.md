...
🎯 Objetivos
Entender o funcionamento do display: flex
Aprender a alinhar elementos horizontal e verticalmente
Trabalhar com distribuição de espaço entre itens
Criar layouts modernos e responsivos
🛠️ Tecnologias utilizadas
HTML5
CSS3 (Flexbox)
📌 Conceitos abordados
Com o uso do Flexbox, foi possível:

Organizar elementos de forma simples
Criar layouts mais limpos
Melhorar a responsividade da página
📖 Conclusão

A atividade permitiu compreender a importância do Flexbox no desenvolvimento front-end, tornando o processo de criação de layouts mais rápido, intuitivo e eficiente.
